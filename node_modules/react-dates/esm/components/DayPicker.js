    ...
    value: function () {
      function renderWeekHeader(index) {
        ...
        return React.createElement(
          'div',
          _extends({}, css(styles.DayPicker_weekHeader, this.isVertical() && styles.DayPicker_weekHeader__vertical, verticalScrollable && styles.DayPicker_weekHeader__verticalScrollable, weekHeaderStyle, { padding: '0 ' + String(horizontalMonthPadding) + 'px' }), {
...
export default withStyles(function (_ref2) {
  ...
  return {
    ...
    DayPicker_transitionContainer__verticalScrollable: _objectAssign({
      paddingTop: 20,
      height: '100%',
      position: 'absolute',
      top: 0,
