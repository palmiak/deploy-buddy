...
function Flyout(props, forwardedRef) {
  ...
  const triggerContent = useCallback(triggerProps => {
  ...
  return createElement(FlyoutContext.Provider, {
    value: contextProps
  }, trigger && createElement(PopoverDisclosure, _extends({}, flyoutState, {
    ref: trigger.ref
  }, trigger.props), triggerContent), createElement(Portal, null, createElement(FlyoutContent, _extends({
    ref: forwardedRef
  }, otherProps, {
    elevation: elevation,
    maxWidth: maxWidth
