 ...
 */
export declare type PolymorphicComponentProps<P, T extends React.ElementType, IsPolymorphic extends boolean = true> = P & Omit<React.ComponentPropsWithRef<T>, 'as' | keyof P | 'children'> & (IsPolymorphic extends true ? {
    as?: T | keyof JSX.IntrinsicElements;
} : {
    as?: never;
});
export declare type PolymorphicComponent<T extends React.ElementType, O, IsPolymorphic extends boolean> = {
    <TT extends React.ElementType>(props: PolymorphicComponentProps<O, TT, IsPolymorphic> & (IsPolymorphic extends true ? {
        as: TT;
    } : {
        as: never;
    })): JSX.Element | null;
    (props: PolymorphicComponentProps<O, T, IsPolymorphic>): JSX.Element | null;
    displayName?: string;
    /**
...
export declare type PolymorphicComponentFromProps<Props> = Props extends PolymorphicComponentProps<infer P, infer T, infer I> ? PolymorphicComponent<T, P, I> : never;
