...
export declare type HStackAlignment = 'bottom' | 'bottomLeft' | 'bottomRight' | 'center' | 'edge' | 'left' | 'right' | 'stretch' | 'top' | 'topLeft' | 'topRight';
export declare type AlignmentProps = {
    justify?: CSSProperties['justifyContent'];
    align?: CSSProperties['alignItems'];
};
export declare type Alignments = Record<HStackAlignment, AlignmentProps>;
export declare type Props = Omit<FlexProps, 'align' | 'gap'> & {
    /**
