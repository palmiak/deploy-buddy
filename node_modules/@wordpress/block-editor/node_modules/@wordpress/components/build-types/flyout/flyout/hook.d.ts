 ...
 */
export function useFlyout(props: import('../../ui/context').PolymorphicComponentProps<import('../types').Props, 'div', false>): {
    elevation: number;
    maxWidth: string | number;
    flyoutState: import("reakit/ts").PopoverStateReturn;
    label?: string | undefined;
    onVisibleChange?: ((...args: any) => void) | undefined;
    trigger: import("react").FunctionComponentElement<any>;
