...
export const getBlock = createSelector((state, clientId) => {
  const block = state.blocks.byClientId[clientId];
...
export const getBlocks = createSelector((state, rootClientId) => {
  return map(getBlockOrder(state, rootClientId), clientId => getBlock(state, clientId));
}, (state, rootClientId) => map(state.blocks.order[rootClientId || ''], id => state.blocks.cache[id]));
/**
...
export const __unstableGetBlockWithBlockTree = createSelector((state, clientId) => {
  const block = state.blocks.byClientId[clientId];
...
export const __unstableGetBlockTree = createSelector((state, rootClientId = '') => map(getBlockOrder(state, rootClientId), clientId => __unstableGetBlockWithBlockTree(state, clientId)), state => [state.blocks.byClientId, state.blocks.order, state.blocks.attributes]);
/**
...
export const __unstableGetClientIdsTree = createSelector((state, rootClientId = '') => map(getBlockOrder(state, rootClientId), clientId => __unstableGetClientIdWithClientIdsTree(state, clientId)), state => [state.blocks.order]);
/**
...
export const getBlocksByClientId = createSelector((state, clientIds) => map(castArray(clientIds), clientId => getBlock(state, clientId)), state => [state.blocks.byClientId, state.blocks.order, state.blocks.attributes]);
/**
...
export const getBlockTransformItems = createSelector((state, blocks, rootClientId = null) => {
  ...
  const itemsByName = mapKeys(blockTypeTransformItems, ({
    name
  }) => name);
...
export const __experimentalGetAllowedPatterns = createSelector((state, rootClientId = null) => {
  ...
  const patternsAllowed = filter(availableParsedPatterns, ({
    blocks
  }) => blocks.every(({
    name
...
export const __experimentalGetParsedReusableBlock = createSelector((state, ref) => {
