 ...
 */
import { useState, createPortal, useCallback, forwardRef, useEffect, useMemo, useReducer } from '@wordpress/element';
...
function Iframe({
  ...
  head = createElement(Fragment, null, createElement("style", null, 'body{margin:0}'), styles.map(({
    tagName,
    href,
    id,
    rel,
  ...
  return createElement(Fragment, null, before, createElement("iframe", _extends({}, props, {
    ref: useMergeRefs([ref, setRef]),
    tabIndex: "0",
    title: __('Editor canvas'),
    name: "editor-canvas"
  }), iframeDocument && createPortal(createElement(StyleProvider, {
    document: iframeDocument
  }, children), iframeDocument.body), iframeDocument && createPortal(head, iframeDocument.head)), after);
}
