...
exports.__experimentalGetActiveBlockIdByBlockNames = exports.__experimentalGetReusableBlockTitle = exports.__experimentalGetParsedReusableBlock = exports.__experimentalGetBlockListSettingsForBlocks = exports.__experimentalGetPatternTransformItems = exports.__experimentalGetPatternsByBlockTypes = exports.__experimentalGetAllowedPatterns = exports.__experimentalGetParsedPattern = exports.__experimentalGetAllowedBlocks = exports.hasInserterItems = exports.getBlockTransformItems = exports.getInserterItems = exports.canInsertBlockType = exports.isAncestorMultiSelected = exports.getMultiSelectedBlocks = exports.getSelectedBlockClientIds = exports.getBlockParentsByBlockName = exports.getBlockParents = exports.getBlocksByClientId = exports.getGlobalBlockCount = exports.getClientIdsWithDescendants = exports.getClientIdsOfDescendants = exports.__unstableGetClientIdsTree = exports.__unstableGetClientIdWithClientIdsTree = exports.__unstableGetBlockTree = exports.__unstableGetBlockWithBlockTree = exports.getBlocks = exports.__unstableGetBlockWithoutInnerBlocks = exports.getBlock = void 0;
...
const getBlock = (0, _rememo.default)((state, clientId) => {
  const block = state.blocks.byClientId[clientId];
...
const getBlocks = (0, _rememo.default)((state, rootClientId) => {
  return (0, _lodash.map)(getBlockOrder(state, rootClientId), clientId => getBlock(state, clientId));
}, (state, rootClientId) => (0, _lodash.map)(state.blocks.order[rootClientId || ''], id => state.blocks.cache[id]));
/**
...
const __unstableGetBlockWithBlockTree = (0, _rememo.default)((state, clientId) => {
  const block = state.blocks.byClientId[clientId];
...
const __unstableGetBlockTree = (0, _rememo.default)((state, rootClientId = '') => (0, _lodash.map)(getBlockOrder(state, rootClientId), clientId => __unstableGetBlockWithBlockTree(state, clientId)), state => [state.blocks.byClientId, state.blocks.order, state.blocks.attributes]);
/**
...
const __unstableGetClientIdsTree = (0, _rememo.default)((state, rootClientId = '') => (0, _lodash.map)(getBlockOrder(state, rootClientId), clientId => __unstableGetClientIdWithClientIdsTree(state, clientId)), state => [state.blocks.order]);
/**
...
const getBlocksByClientId = (0, _rememo.default)((state, clientIds) => (0, _lodash.map)((0, _lodash.castArray)(clientIds), clientId => getBlock(state, clientId)), state => [state.blocks.byClientId, state.blocks.order, state.blocks.attributes]);
/**
...
const getInserterItems = (0, _rememo.default)((state, rootClientId = null) => {
  ...
  const buildReusableBlockInserterItem = reusableBlock => {
    ...
    return {
      ...
      icon: referencedBlockType ? referencedBlockType.icon : _icons.symbol,
      category: 'reusable',
      keywords: [],
      isDisabled: false,
      utility: 1,
...
const __experimentalGetParsedReusableBlock = (0, _rememo.default)((state, ref) => {
