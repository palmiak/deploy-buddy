...
function getNestedBlockClientIds(blocksOrder, rootClientId = '', controlledInnerBlocks = {}) {
  return (0, _lodash.reduce)(blocksOrder[rootClientId], (result, clientId) => {
...
const withBlockCache = reducer => (state = {}, action) => {
  ...
  switch (action.type) {
    case 'RESET_BLOCKS':
      newState.cache = (0, _lodash.mapValues)(flattenBlocks(action.blocks), () => ({}));
      break;

    case 'RECEIVE_BLOCKS':
    case 'INSERT_BLOCKS':
      {
        const updatedBlockUids = (0, _lodash.keys)(flattenBlocks(action.blocks));
    ...
    case 'REPLACE_BLOCKS_AUGMENTED_WITH_CHILDREN':
      ...
      newState.cache = { ...(0, _lodash.omit)(newState.cache, action.replacedClientIds),
        ...(0, _lodash.omit)(parentClientIds, action.replacedClientIds),
        ...fillKeysWithEmptyObject((0, _lodash.keys)(flattenBlocks(action.blocks)))
      };
      break;

    case 'REMOVE_BLOCKS_AUGMENTED_WITH_CHILDREN':
      newState.cache = { ...(0, _lodash.omit)(newState.cache, action.removedClientIds),
        ...fillKeysWithEmptyObject((0, _lodash.difference)(getBlocksWithParentsClientIds(action.clientIds), action.clientIds))
      };
      break;
...
const withBlockReset = reducer => (state, action) => {
  if (state && action.type === 'RESET_BLOCKS') {
    ...
    const controlledInnerBlocks = Object.keys((0, _lodash.pickBy)(state.controlledInnerBlocks));
    /**
    ...
    return { ...state,
      byClientId: { ...(0, _lodash.omit)(state.byClientId, visibleClientIds),
        ...getFlattenedBlocksWithoutAttributes(action.blocks)
      },
      attributes: { ...(0, _lodash.omit)(state.attributes, visibleClientIds),
        ...getFlattenedBlockAttributes(action.blocks)
      },
      order: { ...(0, _lodash.omit)(state.order, visibleClientIds),
        ...(0, _lodash.omit)(mapBlockOrder(action.blocks), controlledInnerBlocks)
      },
      parents: { ...(0, _lodash.omit)(state.parents, visibleClientIds),
        ...mapBlockParents(action.blocks)
      },
      cache: { ...(0, _lodash.omit)(state.cache, visibleClientIds),
        ...(0, _lodash.omit)((0, _lodash.mapValues)(flattenBlocks(action.blocks), () => ({})), controlledInnerBlocks)
      }
    };
  }
...
withBlockReset, withPersistentBlockChange, withIgnoredBlockChange)({
  ...
  order(state = {}, action) {
    switch (action.type) {
      ...
      case 'RECEIVE_BLOCKS':
        return { ...state,
          ...(0, _lodash.omit)(mapBlockOrder(action.blocks), '')
        };
