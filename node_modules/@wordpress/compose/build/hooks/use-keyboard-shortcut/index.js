...
shortcuts, callback, {
  ...
  (0, _element.useEffect)(() => {
    ...
    const mousetrap = new _mousetrap.default(target && target.current ? target.current : // We were passing `document` here previously, so to successfully cast it to Element we must cast it first to `unknown`.
    ...
    /** @type {unknown} */
    document);
    (0, _lodash.castArray)(shortcuts).forEach(shortcut => {
