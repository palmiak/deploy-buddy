...
export default function createReduxStore(key, options) {
  return {
    ...
    instantiate: registry => {
      ...
      let selectors = mapSelectors({ ...mapValues(metadataSelectors, selector => (state, ...args) => selector(state.metadata, ...args)),
...
function instantiateReduxStore(key, options, registry, thunkArgs) {
  ...
  const middlewares = [createResolversCacheMiddleware(registry, key), promise, createReduxRoutineMiddleware(normalizedControls)];
...
function mapResolveSelectors(selectors, store) {
  return mapValues(omit(selectors, ['getIsResolving', 'hasStartedResolution', 'hasFinishedResolution', 'isResolving', 'getCachedResolvers']), (selector, selectorName) => (...args) => new Promise(resolve => {
