...
function toFormat({
  ...
  if (!formatType) {
    formatType = (0, _data.select)(_store.store).getFormatTypeForBareElement(type);
  }
...
const ZWNBSPRegExp = new RegExp(_specialCharacters.ZWNBSP, 'g');
/**
...
function createFromElement({
  ...
  for (let index = 0; index < length; index++) {
    ...
    const format = (0, _isFormatEqual.isFormatEqual)(newFormat, lastFormat) ? lastFormat : newFormat;
