...
function changeListType(value, newFormat) {
  ...
  const endLineFormats = replacements[(0, _getLineIndex.getLineIndex)(value, end)] || [];
  const startIndex = (0, _getParentLineIndex.getParentLineIndex)(value, startingLineIndex);
