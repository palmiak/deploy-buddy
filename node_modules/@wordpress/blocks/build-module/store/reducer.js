    ...
    case 'ADD_BLOCK_TYPES':
      return { ...state,
        ...mapValues(keyBy(action.blockTypes, 'name'), blockType => {
          return uniqBy([...get(blockType, ['styles'], []), ...get(state, [blockType.name], [])], style => style.name);
        })
      };

    case 'ADD_BLOCK_STYLES':
      return { ...state,
        [action.blockName]: uniqBy([...get(state, [action.blockName], []), ...action.styles], style => style.name)
      };
...
export function blockVariations(state = {}, action) {
  switch (action.type) {
    case 'ADD_BLOCK_TYPES':
      return { ...state,
        ...mapValues(keyBy(action.blockTypes, 'name'), blockType => {
          return uniqBy([...get(blockType, ['variations'], []), ...get(state, [blockType.name], [])], variation => variation.name);
        })
      };

    case 'ADD_BLOCK_VARIATIONS':
      return { ...state,
        [action.blockName]: uniqBy([...get(state, [action.blockName], []), ...action.variations], variation => variation.name)
      };
