...
import { every, castArray, some, isObjectLike, filter, first, flatMap, has, uniq, isFunction, isEmpty, map } from 'lodash';
/**
...
export function switchToBlockType(blocks, name) {
  ...
  const ret = transformationResults.map(result => {
     ...
     */
    return applyFilters('blocks.switchToBlockType.transformedBlock', result, blocks);
  });
  return ret;
}
/**
