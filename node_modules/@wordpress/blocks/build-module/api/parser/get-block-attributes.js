...
export const toBooleanAttributeMatcher = matcher => flow([matcher, // Expected values from `attr( 'disabled' )`:
//
// <input>
// - Value:       `undefined`
// - Transformed: `false`
...
export function matcherFromSource(sourceConfig) {
  switch (sourceConfig.source) {
    ...
    case 'tag':
      return flow([prop(sourceConfig.selector, 'nodeName'), nodeName => nodeName ? nodeName.toLowerCase() : undefined]);
