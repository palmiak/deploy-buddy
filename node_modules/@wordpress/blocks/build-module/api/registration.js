 ...
 */
import { camelCase, isArray, isEmpty, isFunction, isNil, isObject, isPlainObject, isString, mapKeys, omit, pick, pickBy, some } from 'lodash';
/**
...
export function unstable__bootstrapServerSideBlockDefinitions(definitions) {
  for (const blockName of Object.keys(definitions)) {
    ...
    serverSideBlockDefinitions[blockName] = mapKeys(pickBy(definitions[blockName], value => !isNil(value)), (value, key) => camelCase(key));
  }
}
/**
...
export function registerBlockType(blockNameOrMetadata, settings) {
  ...
  if ('category' in settings && !some(select(blocksStore).getCategories(), {
