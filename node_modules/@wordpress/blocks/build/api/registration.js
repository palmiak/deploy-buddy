...
exports.unregisterBlockVariation = exports.registerBlockVariation = exports.getBlockVariations = exports.unregisterBlockStyle = exports.registerBlockStyle = exports.hasChildBlocksWithInserterSupport = exports.hasChildBlocks = exports.getChildBlockNames = exports.serverSideBlockDefinitions = void 0;
...
function registerBlockType(blockNameOrMetadata, settings) {
  ...
  if (settings.deprecated) {
    ...
    { // Omit deprecation keys here so that deprecations
      ...
      ...(0, _lodash.omit)(preFilterSettings, _constants.DEPRECATED_ENTRY_KEYS),
      ...deprecation
    }, name), _constants.DEPRECATED_ENTRY_KEYS));
  }
  ...
  if ('category' in settings && !(0, _lodash.some)((0, _data.select)(_store.store).getCategories(), {
  ...
  (0, _data.dispatch)(_store.store).addBlockTypes(settings);
  return settings;
}
/**
...
function translateBlockSettingUsingI18nSchema(i18nSchema, settingValue, textdomain) {
  ...
  if ((0, _lodash.isArray)(i18nSchema) && !(0, _lodash.isEmpty)(i18nSchema) && (0, _lodash.isArray)(settingValue)) {
