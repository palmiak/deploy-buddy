...
const TEXT_NORMALIZATIONS = [_lodash.identity, getTextWithCollapsedWhitespace];
/**
...
const isEqualAttributesOfName = {
  class: (actual, expected) => {
    ...
    return !(0, _lodash.xor)(...[actual, expected].map(getTextPiecesSplitOnWhitespace)).length;
  },
  style: (actual, expected) => {
    return (0, _lodash.isEqual)(...[actual, expected].map(getStyleProperties));
  },
  // For each boolean attribute, mere presence of attribute in both is enough
  // to assume equivalence.
  ...(0, _lodash.fromPairs)(BOOLEAN_ATTRIBUTES.map(attribute => [attribute, _lodash.stubTrue]))
};
/**
