...
?>
<h2><?php _e( 'Installation', Config::get( 'language_slug' ) ); ?></h2>

<h3><?php _e( 'Get your webhook url', Config::get( 'language_slug' ) ); ?></h3>
...
<h3><?php _e( 'Configure the plugin', Config::get( 'language_slug' ) ); ?></h3>
...
<h4><?php _e( 'Other constants', Config::get( 'language_slug' ) ); ?></h4>
